SRC_DIR := src/Collider src/Utilities src/GameState src/Interface src/Action src/GameObject src/Components src/Components/Data src/Components/Renderer src
